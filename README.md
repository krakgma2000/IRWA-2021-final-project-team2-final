...
The project has already ended, and it contains the repository containing the final web application
...
You will find a repository that you just need to donwload to your computer. After this, go inside the repository and just run the web_app.py python code in an appropiate virtual environment. The environment must have the following dependencies installed:
